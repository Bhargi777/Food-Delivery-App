...
/**
 * Manages the creation and display of the initial restaurant dataset.
...
public class DataProvider {
    public static List<Restaurant> createRestaurantData() {
        ...
        Restaurant[] initialRestaurants = new Restaurant[]{
            ...
            new Restaurant("The Salad Bar", 9, 4.4, "Healthy", 
                new ArrayList<>(List.of(
                    new MenuItem("Caesar Salad", 10.0), 
                    new MenuItem("Greek Salad", 11.0)
                ))),
            new Restaurant("Dosa Den", 13, 4.5, "South Indian", 
                new ArrayList<>(List.of(
        ...
        // Return a mutable list to allow admins to add restaurants

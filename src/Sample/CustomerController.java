...
/**
 * Implements the entire workflow for the customer, from searching
 * for restaurants to adding items to the cart and checking out.
...
public class CustomerController {
    ...
    public static void runCustomerLoop(List<Restaurant> restaurants, Scanner scanner) {
        ...
        SortedRestaurantList sortedList = RestaurantSorter.buildSortedRestaurantList(restaurantArray);
        ...
        while (stayInMenu) {
            ...
            switch (choice) {
                case 1:
                    performSearchAndAddItem(scanner, sortedList, userLocation, currentOrder);
                    break;
                case 2:
    ...
    private static void performSearchAndAddItem(Scanner scanner, SortedRestaurantList sortedList, int userLocation, List<OrderItem> order) {
        ...
        List<Restaurant> availableRestaurants = RestaurantFinder.findRestaurantsInRange(sortedList, minLocation, maxLocation);
